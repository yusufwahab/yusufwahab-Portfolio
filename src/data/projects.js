...
const newProjects = [
  {
    ...
    githubUrl: 'https://github.com/yusufwahab/Traxs',
    featured: true,
    status: 'Live',
...
is_flagged = model.predict(entity_features) == -1`,
  ...
  },
  {
    ...
    githubUrl: 'https://github.com/yusufwahab/VoiceIQ',
    featured: true,
    status: 'Live',
    categories: ['AI & ML'],
  ...
  },
  {
    ...
    githubUrl: 'https://github.com/yusufwahab/SwiftSettle',
    featured: true,
    status: 'Live',
  ...
  },
  {
    ...
    githubUrl: 'https://github.com/yusufwahab/RentStack',
    featured: true,
    status: 'Live',
    categories: ['Fintech Infra'],
    stackTags: ['React 19', 'Vite', 'React Router 7', 'Recharts', 'Node.js', 'Express', 'PostgreSQL', 'Supabase', 'Nomba'],
